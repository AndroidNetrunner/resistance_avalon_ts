  ...
  callback: () => {
    const embed = new MessageEmbed()
      ...
      .addFields(
        ...
        makeField(
          "/참가",
          "시작한 게임을 참가합니다. 시작한 게임이 존재하지 않거나 게임이 마감된 상태라면 사용할 수 없습니다."
        ),
        makeField(
          "/마감",
          "참가를 마감하고 게임을 시작하기 위한 명령어입니다. 마감되지 않은 게임이 없다면 사용할 수 없습니다."
        ),
        makeField(
          "/리셋",
        ...
        makeField(
          "/순서",
          "원정대장이 이동하는 순서를 출력합니다. 진행 중인 게임이 없으면 사용할 수 없습니다."
        ),
        makeField(
          "/추가 X",
          "새로운 역할을 추가합니다. X는 추가할 역할을 뜻합니다. 참가를 받는 동안에만 사용할 수 있습니다. 예) /추가 퍼시발"
        ),
        makeField(
          "/삭제 X",
